...
| Current milestone | M1 — passive local MVP complete |
| Overall status | M0 and M1 pass locally and on hosted GNU/Linux x64, macOS ARM64, and Windows x64; the separate hosted four-server compatibility matrix also passes |
| Current focus | `MCPD-008` — ready for the next goal |
| Public release | None |
