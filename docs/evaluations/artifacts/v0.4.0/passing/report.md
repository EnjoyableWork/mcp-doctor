...
#### Finding 1: `MCP-PROTOCOL-001`

- Severity: `info`
- Protocol revision: `2026-07-28`
- Location: `server.supportedVersions`
- What: The requested protocol revision is supported.
- Why: The advertised revision determines which protocol rules can be applied.
- Evidence: None.
- Expected: The server confirms the exact MCP revision selected for this diagnostic.
- Corrective action: No correction is needed.
